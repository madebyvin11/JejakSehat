...
export const ScrollStackItem = ({
  ...
  <div
    className={`scroll-stack-card relative w-full mx-auto my-8 rounded-2xl bg-transparent shadow-none box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div className="no-scrollbar scroll-stack-inner pt-4 px-4 pb-4">
        {children}
